...
public class SpongeCrossExaminationManager : MonoBehaviour
{
    ...
    public void PressWitness()
    {
        ...
        StartCoroutine(PressSequence(line));
    }

    IEnumerator PressSequence(SpongeTestimonyLine line)
    {
        yield return StartCoroutine(SpongeUIManager.Instance.PlayHolditAnim());
